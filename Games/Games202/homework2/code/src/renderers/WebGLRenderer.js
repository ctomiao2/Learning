class WebGLRenderer {
    ...
    render() {
        ...
        let precomputeL_Mat3 = getMat3ValueFromRGB(precomputeL_RGBMat3);
        ...
        for (let l = 0; l < this.lights.length; l++) {
            ...
            for (let i = 0; i < this.meshes.length; i++) {
                ...
                for (let k in this.meshes[i].material.uniforms) {
                    ...
                    else if (k == 'uPrecomputeLR') {
                        this.meshes[i].material.uniforms['uPrecomputeLR'].value = precomputeL_Mat3[0];
                    }
                    else if (k == 'uPrecomputeLG') {
                        this.meshes[i].material.uniforms['uPrecomputeLG'].value = precomputeL_Mat3[1];
                    }
                    else if (k == 'uPrecomputeLB') {
                        this.meshes[i].material.uniforms['uPrecomputeLB'].value = precomputeL_Mat3[2];
                    }   
                }
